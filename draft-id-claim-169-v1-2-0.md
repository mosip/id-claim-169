...
The attributes listed below are already included as part of the standard CWT structure protected or unprotected header and therefore do not need to be separately specified within Claim 169. Implementers should refer to the standard COSE definitions for format and usage.

These fields are inherently part of the COSE structure and must be interpreted according to the standard specification. For details, refer to the [IANA COSE registry here](https://www.iana.org/assignments/cose/cose.xhtml). The issuer MUST decide to include any of these attributes for public key discovery based on the size of the QR Code.

**Included Attributes:**

| Attribute | Attribute Type    | Attribute Name        | Description                                                |
| --------- | ----------------- | --------------------- | ---------------------------------------------------------- |
| `32`       | `COSE_X509`      | x5bag                 | An unordered list of X.509 certificates                    |
